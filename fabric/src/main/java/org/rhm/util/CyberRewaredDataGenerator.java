    ...
    public void onInitializeDataGenerator(FabricDataGenerator fabricDataGenerator) {
        ...
        pack.addProvider((dataOutput, registryLookup) -> new LanguageProvider(dataOutput, "en_us", registryLookup) {
            ...
            public void generateTranslations(HolderLookup.Provider wrapperLookup, TranslationBuilder builder) {
                ...
                builder.add("config." + CyberRewaredMod.MOD_ID + ".option.engineering_chance", "Engineering Table Blueprint Chance");
                builder.add("config." + CyberRewaredMod.MOD_ID + ".option.engineering_chance.ttp", "Chance to get a blueprint when smashing a Cyberitem in an Engineering Table");
                builder.add("config." + CyberRewaredMod.MOD_ID + ".option.brute_chance", "Natural Brute Chance");
                builder.add("config." + CyberRewaredMod.MOD_ID + ".option.brute_chance.ttp", "Chance to spawn a Brute instead of a normal Cyberzombie");
                ...
                builder.add(ItemRegistry.KATANA, "Katana");
                ...
                builder.add(CyberRewaredMod.MOD_ID + ".gui.scannerSayings", String.join("\n", new String[]{
                    ...
                    "Running \"sudo rm --no-preserve-root -rf \""
                }));
